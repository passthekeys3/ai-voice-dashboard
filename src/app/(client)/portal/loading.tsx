export default function PortalLoading() {
    return (
        <div className="space-y-6 p-4 sm:p-6 animate-pulse">
            ...
            {/* Chart + Agents sidebar skeleton */}
            <div className="grid gap-4 md:grid-cols-7">
                <div className="md:col-span-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-card p-6 space-y-4">
                ...
                <div className="md:col-span-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-card p-6 space-y-4">
                    <div className="h-5 w-28 bg-slate-200 dark:bg-slate-800 rounded" />
                    <div className="space-y-3">
                        {Array.from({ length: 3 }).map((_, i) => (
                            <div
                                key={i}
                                className="h-8 bg-slate-100 dark:bg-slate-800/60 rounded"
                            />
                        ))}
                    </div>
                </div>
