...
const securityHeaders = [
    ...
    { key: 'Permissions-Policy', value: 'camera=(), microphone=(self), geolocation=()' },
    {
        ...
        value: [
            ...
            "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://api.retellai.com https://api.vapi.ai https://api.bland.ai https://api.elevenlabs.io https://api.anthropic.com https://*.ingest.us.sentry.io https://*.sentry.io https://va.vercel-scripts.com https://vitals.vercel-analytics.com",
                ...
                headers: [
                    { key: 'X-Content-Type-Options', value: 'nosniff' },
                    {
                        ...
                        value: [
                            ...
                            "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.retellai.com https://api.vapi.ai https://api.bland.ai https://api.elevenlabs.io",
                            "media-src 'self' https: blob:",
                            "object-src 'none'",
                            "base-uri 'self'",
                            "frame-ancestors *",
